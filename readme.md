<h1><strong>Startup HTML template based on Gulp & Bootstrap 4</h1>

<p>HTML5 template with Bootstrap 4 (grid & reboot), Gulp, Sass, Browsersync, Autoprefixer, Clean-CSS, Uglify, Rsync and Bower (libs path) support. The template contains a <strong>.htaccess</strong> file with caching rules for web server.</p>
...
<ol>
	<li><a href="https://github.com/de4ev/start_template/archive/master.zip">Download</a> <strong>template</strong> from GitHub;</li>
